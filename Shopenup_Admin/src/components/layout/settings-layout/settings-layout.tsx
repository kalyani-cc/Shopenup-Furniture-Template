import { ArrowUturnLeft, MinusMini } from "@shopenup/icons"
import { clx, Divider, IconButton, Text } from "@shopenup/ui"
...
const useSettingRoutes = (): INavItem[] => {
  ...
  return useMemo(
    () => [
      ...
      // {
      //   label: t("doctorAppointments.domain"),
      //   to: "/settings/doctor-appointments",
      // },
    ],
    [t]
  )
