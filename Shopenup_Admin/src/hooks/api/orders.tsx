...
import { CreateOrderCreditLineDTO, HttpTypes } from "@shopenup/types"
import {
  QueryKey,
  useMutation,
  UseMutationOptions,
...
import { invalidateNotificationQueries } from "./notification"
...
export const useUpdateOrder = (
  ...
  return useMutation({
    ...
    onSuccess: (data: any, variables: any, context: any) => {
      ...
      // Invalidate notifications to show latest order notifications
...
export const useCreateOrderShipment = (
  ...
  return useMutation({
    ...
    onSuccess: (data: any, variables: any, context: any) => {
      ...
      // Invalidate notifications to show latest order shipment notifications
      invalidateNotificationQueries()
...
export const useMarkOrderFulfillmentAsDelivered = (
  ...
  return useMutation({
    ...
    onSuccess: (data: any, variables: any, context: any) => {
      ...
      // Invalidate notifications to show latest order delivered notifications
      invalidateNotificationQueries()
