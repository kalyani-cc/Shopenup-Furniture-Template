import { ArrowDownRightMini, DocumentText, XCircle } from "@shopenup/icons"
import { AdminOrder, AdminPayment, HttpTypes, OrderCreditLineDTO } from "@shopenup/types"
import {
  Badge,
  Button,
  Container,
      ...
      <div className="text-ui-fg-subtle grid grid-cols-[1fr_1fr_1fr_20px] items-center gap-x-4 px-6 py-4 sm:grid-cols-[1fr_1fr_1fr_1fr_20px]">
        <div className="w-full min-w-[60px] overflow-hidden">
          <Text
            ...
            className="truncate"
          >
            <DisplayId id={payment.id} maskAsPayment={true} />
          </Text>
          <Text size="small" leading="compact">
            {format(
          ...
          <div className="flex items-center gap-x-2">
            ...
            <Text size="small" leading="compact">
              <Trans
                ...
                components={[<DisplayId id={payment.id} maskAsPayment={true} />]}
              />
            </Text>
          </div>
    ...
    <div className="divide-y divide-dashed">
      <div className="text-ui-fg-subtle grid grid-cols-[1fr_1fr_20px] items-center gap-x-4 px-6 py-4 sm:grid-cols-[1fr_1fr_1fr_20px]">
        <div className="w-full min-w-[60px] overflow-hidden">
          ...
          <Text size="small" leading="compact">
            {format(
              creditLine.created_at instanceof Date 
            ...
            return (
              <Payment
                ...
                refunds={refunds.filter(
                  (refund) => (typeof refund.payment === 'string' ? refund.payment : refund.payment?.id) === event.id
                )}
