...
import { ArrowUpCircleSolid } from "@shopenup/icons"
import { IconButton } from "@shopenup/ui"
...
export const OrderNoteForm = ({ order }: OrderNoteFormProps) => {
  ...
  const { mutateAsync, isLoading } = useCreateOrderNote()
...
function useCreateOrderNote(): { mutateAsync: any; isLoading: any } {
