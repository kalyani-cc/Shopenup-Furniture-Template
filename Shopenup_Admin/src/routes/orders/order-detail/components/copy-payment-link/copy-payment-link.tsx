import { CheckCircleSolid, SquareTwoStack } from "@shopenup/icons"
import { AdminOrder, AdminPaymentCollection } from "@shopenup/types"
import { Button, Tooltip } from "@shopenup/ui"
import copy from "copy-to-clipboard"
import React, { useState } from "react"
import { useTranslation } from "react-i18next"
import { getStylizedAmount } from "../../../../../lib/money-amount-helpers"
import { SHOPENUP_STOREFRONT_URL } from "../../../../../lib/storefront"
...
const CopyPaymentLink = React.forwardRef<any, CopyPaymentLinkProps>(
  ({ paymentCollection, order }: CopyPaymentLinkProps, ref) => {
    ...
    const copyToClipboard = async (
      ...
      setDone(true)
      copy(
        `${SHOPENUP_STOREFRONT_URL}/payment-collection/${paymentCollection.id}`
      )
