                        ...
                        <Form.Item>
                          ...
                          <Form.Control>
                            <select
                              ...
                              onBlur={field.onBlur}
                              name={field.name}
                              className="bg-ui-bg-field border-ui-border-base txt-compact-small-plus shadow-borders-focus transition-fg flex h-9 w-full items-center rounded-md border px-2.5 outline-none focus-visible:border-ui-border-interactive"
                            >
