...
import { Text, Switch, Label, Button, IconButton, Checkbox, Heading, Select, Tooltip, TooltipProvider, Badge } from "@shopenup/ui";
import { Adjustments, ExclamationCircle } from "@shopenup/icons"
import { Grid } from "@mui/material";
import { DateLasts, OrderStatus } from "../utils/types";
import type { DateRange } from "../utils/types";
import { DropdownMenu, toast } from "@shopenup/ui"
...
export const GenerateReportButton = ({orderStatuses, dateRange, dateRangeCompareTo, compareEnabled} : 
  ...
  const generate = async () => {
    ...
    fetch(`${API_BASE_URL}/admin/reports-analytics/general`, {
      method: "POST",
      credentials: "include",
      headers: {
