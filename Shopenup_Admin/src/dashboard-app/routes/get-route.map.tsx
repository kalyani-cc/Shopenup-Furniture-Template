      ...
      children: [
        {
          ...
          children: [
            ...
            },
            {
              ...
              lazy: async () => {
                const { Blogs } = await import("../../routes/blogs")
            ...
            },
            {
              ...
              lazy: async () => {
                const { Reviews } = await import("../../routes/reviews")
            ...
            //       path: "",
            //       lazy: async () => {
            //         const { AppointmentList } = await import("../../routes/appointments/appointment-list")
            //         return { Component: AppointmentList }
            //       },
            //     },
            //     {
            //       path: ":id",
            //       errorElement: <ErrorBoundary />,
            //       lazy: async () => {
            //         const { AppointmentDetail } = await import("../../routes/appointments/appointment-detail")
            //         return { Component: AppointmentDetail }
            //       },
            //     },
            //   ],
            // },
            {
              ...
              lazy: async () => {
                const { NotificationsPage } = await import("../../routes/notifications")
      ...
      children: [
        {
          ...
          children: [
            ...
            //   errorElement: <ErrorBoundary />,
            //   lazy: () => import("../../routes/settings/doctor-appointments"),
            //   handle: {
            //     breadcrumb: () => t("doctorAppointments.domain"),
            //   },
            // },
