...
export class Migration20250123120000 extends Migration {
  ...
  override async up(): Promise<void> {
    this.addSql(`
      create table if not exists "shiprocket_return_new" (
        "id" text not null,
  ...
  override async down(): Promise<void> {
    this.addSql(`drop table if exists "shiprocket_return" cascade;`)
  }
