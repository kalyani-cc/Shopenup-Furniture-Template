...
export function ContactMethod({ icon, title, content, description }: ContactMethodProps) {
  return (
    <div className="flex gap-5">
      ...
      <div>
        <h3 className="text-sm font-bold uppercase tracking-wider text-stone-500">{title}</h3>
        <p className="mt-1 text-lg font-semibold text-stone-900">{content}</p>
